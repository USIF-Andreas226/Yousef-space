...
WORK: AI Engineer at Wider (Multinational, 2025-Present) - backend AI agent infra, Knowledge Graph, LLM extraction, LangChain REST APIs. AI Engineer Intern at Kayfa (Multinational, 2026-Present) - multilingual LangGraph sales agent with RAG over 52-course catalog, lead scoring, Twilio WhatsApp, student analytics dashboard consolidating 7 LMS sources with 37-issue data-quality audit and Plotly EDA. Head of AI at iCLUB (2024-Present) - workshops on generative AI, deployment, ethics, mentoring Python/TensorFlow.
